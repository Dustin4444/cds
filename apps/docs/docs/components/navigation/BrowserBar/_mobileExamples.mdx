...
```tsx live noPreview
import { BrowserBar, NavBarIconButton, NavigationTitle } from '@coinbase/cds-mobile/navigation';
...
import { BrowserBar, NavBarIconButton } from '@coinbase/cds-mobile/navigation';

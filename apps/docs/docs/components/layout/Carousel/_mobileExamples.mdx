...
```jsx live noPreview
import { ContainedAssetCard } from '@coinbase/cds-mobile/cards';
...
```jsx live noPreview
import { UpsellCard } from '@coinbase/cds-mobile/cards';
import { Carousel, CarouselItem } from '@coinbase/cds-mobile/carousel';
...
import { Card, UpsellCard } from '@coinbase/cds-mobile/cards';
import { Carousel, CarouselItem } from '@coinbase/cds-mobile/carousel';
import { Pictogram } from '@coinbase/cds-mobile/illustrations';
...
```jsx live noPreview
import { Carousel, CarouselItem, DefaultCarouselNavigation } from '@coinbase/cds-mobile/carousel';
...
```tsx live noPreview
import { Carousel } from '@coinbase/cds-mobile/carousel';

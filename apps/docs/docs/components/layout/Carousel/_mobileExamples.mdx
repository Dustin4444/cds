...
By default, autoplay pauses when the user touches anywhere on the carousel area, including the title, navigation, content, and pagination (`autoplayPauseOnInteraction` defaults to `true`). You can customize the delay before autoplay resumes after the user stops interacting using the `autoplayResumeDelay` prop.
...
function PauseOnInteractionCarousel() {
  ...
  return (
    <Carousel
      ...
      loop
      title="Touch to pause (resumes after 500ms)"
      styles={{
        root: { paddingHorizontal: theme.space[3] },
        carousel: { gap: theme.space[1] },
      }}
...
function NoPauseOnInteractionCarousel() {
  ...
  return (
    <Carousel
      ...
      loop
      title="Continues playing on touch"
      styles={{
        root: { paddingHorizontal: theme.space[3] },
        carousel: { gap: theme.space[1] },
      }}

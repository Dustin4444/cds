...
```jsx live
import { ContainedAssetCard } from '@coinbase/cds-web/cards';
...
import { Card, UpsellCard } from '@coinbase/cds-web/cards';
import { Carousel, CarouselItem } from '@coinbase/cds-web/carousel';
...
```jsx live
import { NudgeCard } from '@coinbase/cds-web/cards';
import { Carousel, CarouselItem } from '@coinbase/cds-web/carousel';
import { Box } from '@coinbase/cds-web/layout';
...
```jsx live
import { ContainedAssetCard, NudgeCard } from '@coinbase/cds-web/cards';
import { Carousel, CarouselItem } from '@coinbase/cds-web/carousel';
import { Box } from '@coinbase/cds-web/layout';
import { RemoteImage } from '@coinbase/cds-web/media';
import { Pressable } from '@coinbase/cds-web/system';
...
```jsx live
import { NudgeCard } from '@coinbase/cds-web/cards';
import { Carousel, CarouselItem, DefaultCarouselNavigation } from '@coinbase/cds-web/carousel';
import { Box } from '@coinbase/cds-web/layout';

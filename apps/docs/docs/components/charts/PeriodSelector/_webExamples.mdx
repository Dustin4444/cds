...
```jsx live
import React, { useMemo, useState } from 'react';
import { LiveTabLabel, PeriodSelector } from '@coinbase/cds-web-visualization/chart';
import { Box } from '@coinbase/cds-web/layout';
...
import { Axis, LineChart, PeriodSelector, Scrubber } from '@coinbase/cds-web-visualization/chart';
import { IconButton } from '@coinbase/cds-web/buttons';

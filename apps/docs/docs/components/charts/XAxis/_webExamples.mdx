...
```jsx live
import { CartesianChart, Line, Scrubber, XAxis } from '@coinbase/cds-web-visualization/chart';
...
```jsx live
import { CartesianChart, Line, XAxis } from '@coinbase/cds-web-visualization/chart';
...
```jsx live
import { BarChart } from '@coinbase/cds-web-visualization/chart';
...
import { LineChart, Scrubber, XAxis } from '@coinbase/cds-web-visualization/chart';
...
```jsx live
import React, { useState } from 'react';
import { BarPlot, CartesianChart, SolidLine, XAxis } from '@coinbase/cds-web-visualization/chart';
import { HStack, VStack } from '@coinbase/cds-web/layout';
...
```jsx live
import React, { useState } from 'react';
import { BarPlot, CartesianChart, XAxis } from '@coinbase/cds-web-visualization/chart';
import { HStack, VStack } from '@coinbase/cds-web/layout';
import { SegmentedTabs } from '@coinbase/cds-web/tabs';
import { Text } from '@coinbase/cds-web/typography';

...
```jsx live noPreview
import { CartesianChart, Line, Scrubber, XAxis } from '@coinbase/cds-mobile-visualization/chart';
...
```jsx live noPreview
import { CartesianChart, Line, XAxis } from '@coinbase/cds-mobile-visualization/chart';
...
```jsx live noPreview
import { BarChart } from '@coinbase/cds-mobile-visualization/chart';
...
import { LineChart, Scrubber, XAxis } from '@coinbase/cds-mobile-visualization/chart';
...
```jsx live noPreview
import React, { useState } from 'react';
import { BarPlot, CartesianChart, XAxis } from '@coinbase/cds-mobile-visualization/chart';

...
```jsx live
import { CartesianChart, Line, Scrubber, YAxis } from '@coinbase/cds-web-visualization/chart';
...
```jsx live
import { CartesianChart, Line, YAxis } from '@coinbase/cds-web-visualization/chart';

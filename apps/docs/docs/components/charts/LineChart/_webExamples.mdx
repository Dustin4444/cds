...
```jsx live
import { DottedArea, LineChart } from '@coinbase/cds-web-visualization/chart';
...
```jsx live
import React, { useCallback } from 'react';
import { LineChart, Point } from '@coinbase/cds-web-visualization/chart';
...
import { LineChart, ReferenceLine } from '@coinbase/cds-web-visualization/chart';

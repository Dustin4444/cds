...
```jsx live noPreview
import { LineChart } from '@coinbase/cds-mobile-visualization/chart';
...
import { sparklineInteractiveData } from '@coinbase/cds-common/internal/visualizations/SparklineInteractiveData';
import { LineChart, PeriodSelector, Scrubber } from '@coinbase/cds-mobile-visualization/chart';
...
```jsx live noPreview
import { DottedArea, LineChart } from '@coinbase/cds-mobile-visualization/chart';
...
```tsx live noPreview
import React, { useCallback } from 'react';
import { LineChart, Point } from '@coinbase/cds-mobile-visualization/chart';
...
```tsx live noPreview
import React, { useCallback } from 'react';
import { LineChart, Scrubber, SolidLine } from '@coinbase/cds-mobile-visualization/chart';
...
import { LineChart, ReferenceLine } from '@coinbase/cds-mobile-visualization/chart';
...
import { Group } from '@coinbase/cds-mobile/layout';

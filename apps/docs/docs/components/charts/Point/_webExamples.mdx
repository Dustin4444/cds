...
```jsx live
import { CartesianChart, Point, YAxis } from '@coinbase/cds-web-visualization/chart';
...
```jsx live
import { CartesianChart, Point, XAxis, YAxis } from '@coinbase/cds-web-visualization/chart';

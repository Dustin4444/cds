...
```jsx live noPreview
import { Legend, LineChart } from '@coinbase/cds-mobile-visualization/chart';
import { VStack } from '@coinbase/cds-mobile/layout';
...
```jsx live noPreview
import React, { useCallback, useMemo, useState } from 'react';
import { DefaultLegendShape, Legend, LineChart } from '@coinbase/cds-mobile-visualization/chart';

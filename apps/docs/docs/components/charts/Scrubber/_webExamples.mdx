...
```jsx live
import { DottedArea, LineChart, Scrubber, SolidLine } from '@coinbase/cds-web-visualization/chart';
...
import { DefaultScrubberBeacon, LineChart, Scrubber } from '@coinbase/cds-web-visualization/chart';
...
```jsx live
import { DefaultScrubberLabel, LineChart, Scrubber } from '@coinbase/cds-web-visualization/chart';

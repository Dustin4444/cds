...
import { BarChart, SolidLine } from '@coinbase/cds-web-visualization/chart';
...
```jsx live
import { Bar, BarChart } from '@coinbase/cds-web-visualization/chart';
...
import { candles as btcCandles } from '@coinbase/cds-common/internal/data/candles';
import { BarChart, Scrubber, SolidLine } from '@coinbase/cds-web-visualization/chart';

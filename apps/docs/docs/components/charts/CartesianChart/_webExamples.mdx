...
```jsx live
import { AreaChart, BarChart, LineChart, Scrubber } from '@coinbase/cds-web-visualization/chart';
...
```jsx live
import { Area, CartesianChart, Line } from '@coinbase/cds-web-visualization/chart';
...
```jsx live
import { BarPlot, CartesianChart, XAxis, YAxis } from '@coinbase/cds-web-visualization/chart';
...
```jsx live
import { AreaChart, LineChart, Scrubber } from '@coinbase/cds-web-visualization/chart';
...
import { CartesianChart, Line } from '@coinbase/cds-web-visualization/chart';
...
```tsx live
import React, { useEffect, useState } from 'react';
import { BarPlot, CartesianChart, Line } from '@coinbase/cds-web-visualization/chart';
...
import { CartesianChart, XAxis, YAxis } from '@coinbase/cds-web-visualization/chart';

...
```jsx live noPreview
import { AreaChart } from '@coinbase/cds-mobile-visualization/chart';
...
```jsx live noPreview
import { AreaChart, DottedArea, DottedLine } from '@coinbase/cds-mobile-visualization/chart';
...
```jsx live noPreview
import { AreaChart, SolidArea } from '@coinbase/cds-mobile-visualization/chart';
...
import { AreaChart, DottedArea } from '@coinbase/cds-mobile-visualization/chart';
...
import { AreaChart, Scrubber } from '@coinbase/cds-mobile-visualization/chart';

...
```jsx live
import { AreaChart, DottedArea, DottedLine } from '@coinbase/cds-web-visualization/chart';
...
```jsx live
import { AreaChart, SolidArea } from '@coinbase/cds-web-visualization/chart';
...
import { AreaChart, DottedArea } from '@coinbase/cds-web-visualization/chart';
...
import { AreaChart, Scrubber } from '@coinbase/cds-web-visualization/chart';

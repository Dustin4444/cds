...
export const interactablePressedBackgroundGradient = '--interactable-pressed-bg-gradient';
// Hovered:
...
export const interactableHoveredBackgroundGradient = '--interactable-hovered-bg-gradient';
// Disabled:
...
export const interactableDisabledBackgroundGradient = '--interactable-disabled-bg-gradient';
